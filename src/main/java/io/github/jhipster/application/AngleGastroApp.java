...
public class AngleGastroApp {

    private static final Logger log = LoggerFactory.getLogger(AngleGastroApp.class);

    private final Environment env;

    public AngleGastroApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes angleGastro.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AngleGastroApp.class);
